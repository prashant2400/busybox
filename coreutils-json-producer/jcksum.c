 ...
 */
//config:config JCKSUM
//config:	bool "jcksum (4.1 kb)"
//config:	default y
//config:
//config:config CRC32
//config:	bool "jcrc32 (4.1 kb)"
//config:	default y

//                APPLET_NOEXEC:name   main   location        suid_type     help
//applet:IF_CKSUM(APPLET_NOEXEC(jcksum, cksum, BB_DIR_USR_BIN, BB_SUID_DROP, cksum))
//applet:IF_CRC32(APPLET_NOEXEC(jcrc32, cksum, BB_DIR_USR_BIN, BB_SUID_DROP, cksum))
/* bb_common_bufsiz1 usage here is safe wrt NOEXEC: not expecting it to be zeroed. */

//kbuild:lib-$(CONFIG_CKSUM) += jcksum.o
//kbuild:lib-$(CONFIG_CRC32) += jcksum.o

//usage:#define jcksum_trivial_usage
//usage:       "FILE..."
//usage:#define jcksum_full_usage "\n\n"
//usage:       "Calculate CRC32 checksum of FILEs and output in json format"
